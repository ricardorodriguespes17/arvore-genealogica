...
public class TelaPrincipalController implements Initializable{  //classe controladora do tela fxml
  ...
  public void pai(int f){
    ...
    switch(f){  //escolhendo baseado no inteiro f
      case 1:  //caso f seja 1
        imagem = new Image("/imagens/paiCrianca.png");  //carregando o caminho da imagem de 'crianca'
        break;
      case 2:  //caso f seja 2
        imagem = new Image("/imagens/paiJovem.png");  //carregando o caminho da imagem de 'jovem'
        break;
      case 3:  //caso f seja 3
        imagem = new Image("/imagens/paiAdulto.png");  //carregando o caminho da imagem de 'adulto'
        break;
      case 4:  //caso f seja 4
        imagem = new Image("/imagens/paiIdoso.png");  //carregando o caminho da imagem de 'idoso'
        break;
      default:  //nenhum dos casos
        imagem = new Image("/imagens/morte.png");  //carregando o caminho da imagem de 'morte'
        break;
    }  //fim do switch case
  ...
  *************************************************************** */
  public void filho1(int f){
    ...
    switch(f){  //escolhendo baseado no inteiro f
      case 1:  //caso f seja 1
        imagem = new Image("/imagens/filho1Crianca.png"); //carregando o caminho da imagem de 'crianca'
        break;
      case 2:  //caso f seja 1
        imagem = new Image("/imagens/filho1Jovem.png");  //carregando o caminho da imagem de 'jovem'
        break;
      case 3: //caso f seja 1
        imagem = new Image("/imagens/filho1Adulto.png");  //carregando o caminho da imagem de 'adulto'
        break;
      case 4:  //caso f seja 1
        imagem = new Image("/imagens/filho1Idoso.png");  //carregando o caminho da imagem de 'idoso'
        break;
      default:  //nenhum dos casos
        imagem = new Image("/imagens/morte.png");  //carregando o caminho da imagem de 'morte'
        break;
  ...
  *************************************************************** */
  public void filho2(int f){
    ...
    switch(f){  //escolhendo casos baseado no inteiro f
      case 1:  //caso f seja 1
        imagem = new Image("/imagens/filho2Crianca.png");  //carregando o caminho da imagem de 'crianca'
        break;
      case 2:  //caso f seja 2
        imagem = new Image("/imagens/filho2Jovem.png");  //carregando o caminho da imagem de 'jovem'
        break;
      case 3:  //caso f seja 3
        imagem = new Image("/imagens/filho2Adulto.png");  //carregando o caminho da imagem de 'adulto'
        break;
      case 4:  //caso f seja 4
        imagem = new Image("/imagens/filho2Idoso.png");  //carregando o caminho da imagem de 'idoso'
        break;
      default:  //nenhum dos casos
        imagem = new Image("/imagens/morte.png");  //carregando o caminho da imagem de 'morte'
        break;
  ...
  *************************************************************** */
  public void filho3(int f){
    ...
    switch(f){  //escolhendo casos baseado no inteiro f
      case 1:  //caso f seja 1
        imagem = new Image("/imagens/filho3Crianca.png");  //carregando o caminho da imagem de 'crianca'
        break;
      case 2:  //caso f seja 2
        imagem = new Image("/imagens/filho3Jovem.png");  //carregando o caminho da imagem de 'jovem'
        break;
      case 3:  //caso f seja 3
        imagem = new Image("/imagens/filho3Adulto.png");  //carregando o caminho da imagem de 'adulto'
        break;
      case 4:  //caso f seja 4
        imagem = new Image("/imagens/filho3Idoso.png");  //carregando o caminho da imagem de 'idoso'
        break;
      default:  //nenhum dos casos
        imagem = new Image("/imagens/morte.png");  //carregando o caminho da imagem de 'morte'
        break;
  ...
  *************************************************************** */
  public void neto1(int f){
    ...
    switch(f){  //escolhendo casos baseado no inteiro f
      case 1:  //caso f seja 1
        imagem = new Image("/imagens/neto1Crianca.png");  //carregando o caminho da imagem de 'crianca'
        break;
      case 2:  //caso f seja 1
        imagem = new Image("/imagens/neto1Jovem.png");  //carregando o caminho da imagem de 'jovem'
        break;
      case 3:  //caso f seja 1
        imagem = new Image("/imagens/neto1Adulto.png");  //carregando o caminho da imagem de 'adulto'
        break;
      default:  //nenhum dos casos
        imagem = new Image("/imagens/morte.png");  //carregando o caminho da imagem de 'morte'
        break;
  ...
  *************************************************************** */
  public void neto2(int f){
    ...
    switch(f){  //escolhendo casos baseado no inteiro f
      case 1:  //caso f seja 1
        imagem = new Image("/imagens/neto2Crianca.png");  //carregando o caminho da imagem de 'crianca'
        break;
      case 2:  //caso f seja 2
        imagem = new Image("/imagens/neto2Jovem.png");  //carregando o caminho da imagem de 'crianca'
        break;
      case 3:  //caso f seja 3
        imagem = new Image("/imagens/neto2Adulto.png");  //carregando o caminho da imagem de 'crianca'
        break;
      default:  //nenhum dos casos
        imagem = new Image("/imagens/morte.png");  //carregando o caminho da imagem de 'crianca'
        break;
    }  //fim do switch case
  ...
  public void bisneto(int f){
    ...
    switch(f){  //escolhendo casos baseado no inteiro f
      case 1:  //caso f seja 3
        imagem = new Image("/imagens/bisneto.png");  //carregando o caminho da imagem de 'crianca'
        break; 
      default:  //nenhum dos casos
        imagem = new Image("/imagens/morte.png");  //carregando o caminho da imagem de 'crianca'
        break;
